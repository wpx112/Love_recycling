...
# phone_name = '华硕 U303UB_UX303UB 系列'
print(phone_name)
phone_path = r'D:\wpx\workspace\Love_recycling\property_comb\PC\20190416\ids\{pn}.txt'.format(pn=phone_name)
res_path = r'./property_comb/PC/20190416/results/{pn}.csv'.format(pn=phone_name)
tag_path = r'./property_comb/PC/20190416/tag/{pn}.txt'.format(pn=phone_name)
ppvids = {}
