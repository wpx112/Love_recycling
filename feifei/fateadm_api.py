...
def TestFunc():
    pd_id           = "111300"     #用户中心页可以查询到pd信息
    pd_key          = "dvpLUotZgIpuCjr8UygIRv6uC9n0QRc9"
    app_id          = "311300"     #开发者分成用的账号，在开发者中心可以查询到
    app_key         = "GVJsz2TTZ9BPMC+1KlmWfmvvJGVcIVDt"
    #识别类型，
    ...
    # 通过文件形式识别：
    file_name       = r"D:\wpx\workspace\Love_recycling\tools\yzcode\yzcode.jpg"
